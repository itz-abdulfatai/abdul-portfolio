  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content={`Portfolio | ${settings.name ?? "Abdulfatai Aliyu"}`}
        />
        <meta
      ...
      <section id="portfolio" className="flex flex-col gap-10 py-14">
        ...
        <p className="max-w-[500px]">
          Browse through my diverse portfolio to see the creative projects I’ve
          crafted for satisfied clients.
        </p>
            ...
            <div className="sm:sticky sm:top-0 -mx-8 sm:bg-primary/95 sm:backdrop-blur-sm sm:shadow-md sm:z-40">
              <div className="flex gap-4 justify-center items-center py-4">
                <button
                  onClick={() => {
                    setActiveTab("jobs");
                    scrollToSection("works-heading", "smooth");
                  }}
          ...
          <div id="tab-content">
            {activeTab === "jobs" && (
              <div className="flex flex-wrap gap-5 justify-center">
                ...
                {!loading && jobs.map((p, i) => <ProjectCard p={p} key={i} />)}
              </div>
            )}
            ...
            {activeTab === "portfolio" && (
              <div className="flex flex-wrap gap-5 justify-center">
                ...
                {!loading &&
                  portfolio.map((p, i) => <ProjectCard p={p} key={i} />)}
              </div>
            )}
          </div>
        </div>
