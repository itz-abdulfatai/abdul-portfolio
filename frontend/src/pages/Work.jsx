...
<div className="w-full px-8 min-h-[40vh] md:px-16  pt-14 md:pt-28 ">
  <LittleSpinner className='' />
    ...
    {error && 
            <div className="w-full px-8 min-h-[40vh] md:px-16  pt-14 md:pt-28 flex items-center gap-4 ">
    ...
    <Helmet>
      ...
      <meta name="description" content={work?.description ?? 'Explore this project from my portfolio showcasing my web development and design skills. See how I helped bring this client\'s vision to life.'} />
      <meta property="og:title" content={`${work?.name ?? 'works'} | ${settings?.name ?? 'Abdulfatai Aliyu'}`} />
      <meta property="og:description" content={work?.description ?? 'Explore this project from my portfolio showcasing my web development and design skills. See how I helped bring this client\'s vision to life.'} />
    </Helmet>
    {
   !loading && work && 
    <>
